...
if not URI:
    raise RuntimeError("MEMGRAPH_URI is missing from .env")

if not USERNAME:
    raise RuntimeError("MEMGRAPH_USERNAME is missing from .env")

if not PASSWORD:
    raise RuntimeError("MEMGRAPH_PASSWORD is missing from .env")
...
def load_wikivote(session, rows, batch_size=1000):
    ...
    print()
    print("Loading Wiki-Vote into Memgraph...")
    print("-" * 60)
...
def verify_database(session):
    ...
    print()
    print("=" * 60)
    print("Memgraph Wiki-Vote Verification")
    print("=" * 60)
...
def main():
    ...
    print("=" * 60)
    print("Memgraph Wiki-Vote Dataset Loader")
    print("=" * 60)
    ...
    print()
    print("=" * 60)
    print("Memgraph Wiki-Vote loading completed.")
    print("=" * 60)
